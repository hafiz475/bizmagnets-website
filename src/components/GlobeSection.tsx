...
export const GlobeSection: React.FC = () => {
  return (
    <section id="global" className="relative bg-gradient-to-br from-white via-[#F4F9FF] to-[#F3FBF6] dark:from-[#0A0F1E] dark:via-[#0B1930] dark:to-[#0A1F17] border-t border-[#111C34]/10 dark:border-white/10 overflow-hidden py-16 lg:py-24">
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-2xl">
            {/* English Card */}
            <div className="p-4 rounded-2xl bg-white/75 dark:bg-white/5 border border-white/95 dark:border-white/10 backdrop-blur-md shadow-md shadow-[#111C34]/5">
              <span className="text-[11px] font-bold tracking-widest text-[#1A73E8]">
                ENGLISH
              </span>
              <div className="text-sm font-medium text-[#111C34] dark:text-[#EDF1FA] mt-1">
            ...
            <div className="p-4 rounded-2xl bg-white/75 dark:bg-white/5 border border-white/95 dark:border-white/10 backdrop-blur-md shadow-md shadow-[#111C34]/5">
              ...
              <div className="text-sm font-medium text-[#111C34] dark:text-[#EDF1FA] mt-1 text-right dir-rtl">
